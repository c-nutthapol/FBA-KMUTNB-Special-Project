...
class Progress extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.teacher.project.progress', compact('projects','termFilter','statusFilter'));
    }
    ...
    {
        return Excel::download(new ProjectExport($this->dataProjects), "project-step-3.xlsx");
    }
}
