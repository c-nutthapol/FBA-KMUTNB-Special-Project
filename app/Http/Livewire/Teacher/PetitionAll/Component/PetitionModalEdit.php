...
namespace App\Http\Livewire\Teacher\PetitionAll\Component;
...
class PetitionModalEdit extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.teacher.petition-all.component.petition-modal-edit',['masterStatus' => $masterStatus]);
    }
}
