                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <span
                                            class="inline-block text-xs font-semibold leading-tight text-slate-400 dark:text-slate-400">
                                            ลงทะเบียนโครงงานพิเศษ, ยื่นขอสอบความก้าวหน้า
                                        </span>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <span
                                            class="inline-block text-xs font-semibold leading-tight text-slate-400 dark:text-slate-400">
                                            <i class="bi bi-calendar2-week-fill"></i> 1/04/2566
                                        </span>
                                        <span
                                            class="inline-block mx-1 text-xs font-semibold leading-tight text-slate-400 dark:text-slate-400">
                                            -
                                        ...
                                        <span
                                            class="inline-block text-xs font-semibold leading-tight text-slate-400 dark:text-slate-400">
                                            <i class="bi bi-calendar2-week-fill"></i> 31/07/2566
                                        </span>
                                    </td>
                                    <td
                                        class="px-6 py-3 text-center align-middle bg-transparent border-b dark:border-slate-600 whitespace-nowrap shadow-transparent">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            {{-- <span class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">กรุณาเลือกภาคเรียน/ปีการศึกษา</span> --}}
                        </div>
                        <div class="col-span-2">
                        ...
                        <div class="col-span-2 p-3 bg-gray-100 rounded-lg">
                            <div class="flex items-center mb-2">
                                <input id="steps-1" type="checkbox" class="w-4 h-4 input-checkbox">
                                <label for="steps-1"
                                    class="ml-2 text-base tracking-wide dark:text-white dark:opacity-80">ลงทะเบียนโครงงานพิเศษ</label>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    {{-- <span class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">วันที่เริ่ม</span> --}}
                                </div>
                                <div>
                                    <label class="mb-1 text-sm tracking-wide dark:text-white dark:opacity-80">
                                        วันที่สิ้นสุด
                                    ...
                                    <input type="date" class="input" />
                                    {{-- <span class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">วันที่สิ้นสุด</span> --}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-2 p-3 bg-gray-100 rounded-lg">
                            <div class="flex items-center mb-2">
                                <input id="steps-2" type="checkbox" class="w-4 h-4 input-checkbox">
                                <label for="steps-2"
                        ...
                        <div class="col-span-2 p-3 bg-gray-100 rounded-lg">
                            <div class="flex items-center mb-2">
                                <input id="steps-3" type="checkbox" class="w-4 h-4 input-checkbox">
                                <label for="steps-3"
                        ...
                        <div class="col-span-2 p-3 bg-gray-100 rounded-lg">
                            <div class="flex items-center mb-2">
                                <input id="steps-4" type="checkbox" class="w-4 h-4 input-checkbox">
                                <label for="steps-4"
