                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <img src="https://images.pexels.com/photos/23547/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                            alt="banner" class="object-cover w-auto h-24 rounded-lg">
                                    </td>
                                    <td
                ...
                <div class="p-6">
                    <div class="text-center">
                        <div class="inline-block">
                            ...
                            {{-- ไม่มีรูป --}}
                            <div class="flex items-center justify-center w-auto mx-auto mb-2 bg-gray-300 h-34 rounded-2">
                    ...
                    <div class="p-6">
                        <div class="text-center">
                            <div class="inline-block">
                                ...
                                {{-- ไม่มีรูป --}}
                                {{-- <div
                                    class="flex items-center justify-center w-auto mx-auto mb-2 bg-gray-300 h-34 rounded-2">
                                    <i class="text-4xl bi bi-image-alt leading-0"></i>
                                </div> --}}
                                <input class="h-full p-0 input" type="file">
                                {{-- <span class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">กรุณาอัพโหลดรูปภาพ</span> --}}
