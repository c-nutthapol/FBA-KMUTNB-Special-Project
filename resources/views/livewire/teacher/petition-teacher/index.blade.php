                        ...
                        <tbody>
                            @forelse ($studentRequest as $item)
                                <tr>
                                    ...
                                    <td
                                        class="whitespace-nowrap border-b bg-transparent px-6 py-3 text-center align-middle shadow-transparent dark:border-slate-600">
                                        {{-- @dd($item->project->user_project->where('role', 'teacher1')->first()->user->displayname) --}}
                                            <span class="text-black dark:text-slate-300">
                                                {{$item->project->user_project->where('role', 'teacher1')->first()->user->displayname ?? '' }}
                                            </span>
