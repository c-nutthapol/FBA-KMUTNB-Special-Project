        ...
        <div
            ...
            <div
                ...
                <h5 class="mb-0 tracking-wide dark:text-slate-300">
                    ลงทะเบียนสอบหัวข้อ <span class="text-orange-600">
                        @if ($this->term)
                            (วันที่ {{ dateThai($this->term->project_step->phase_1_start_date ?? '-') }} ถึงวันที่
                            {{ dateThai($this->term->project_step->phase_1_end_date ?? '-') }})
                        @endif
                    </span>
                </h5>
            </div>
