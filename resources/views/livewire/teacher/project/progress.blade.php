        ...
        <div
            ...
            <div
                ...
                <h5 class="mb-0 tracking-wide dark:text-slate-300">
                    ยื่นขอสอบความก้าวหน้า <span class="text-orange-600">(วันที่ {{dateThai($this->term->project_step->phase_2_start_date ?? '-')}} ถึงวันที่ {{dateThai($this->term->project_step->phase_2_end_date ?? '-')}})</span>
                </h5>
            </div>
