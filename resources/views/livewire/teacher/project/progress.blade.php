        ...
        <div
            ...
            <div
                ...
                <div class="flex h-full items-center rounded-3 bg-blue-500 p-3.5 text-white dark:bg-slate-700/40">
                    <i class="bi bi-3-circle-fill text-2xl leading-0 text-white dark:text-blue-500"></i>
                </div>
            ...
            <div class="mb-3 flex flex-col justify-start gap-3 px-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-col gap-3 sm:flex-row">
                    <div class="flex-1">
                        <button type="button"
                            class="btn from-green-500 to-emerald-500 font-medium text-white dark:text-white"
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <div id="dropdown"
                                            ...
                                            <ul class="py-2 text-gray-700 dark:text-white"
                                        ...
                                        class="inline-block dark:text-white font-bold leading-normal text-center text-green-500 uppercase align-middle transition-all ease-in rounded-lg cursor-pointer hover:text-green-700">
                                        <div class="flex flex-row items-center gap-2">
                                            <i class="bi bi-download leading-0"></i>
                                            <span class="block">โหลดเอกสาร</span>
                                        </div>
                                    ...
                                    <td
                                        ...
                                        <div class="inline-block">
                                            <select id="UpdateStatusProject" class="select text-black dark:text-white"
                                                data-id="{{ $project->id }}">
