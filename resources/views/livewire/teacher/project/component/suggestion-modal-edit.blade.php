                ...
                <div class="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2">
                    ...
                    <div class="flex flex-col space-y-3">
                        <div class="flex items-start">
                            <input id="edit_{{$item->id}}" type="checkbox" wire:model.defer="editSuggestionId" value="{{$item->id}}"

                                class="mt-1 input-checkbox">
                            <label for="edit_{{$item->id}}" class="ml-2 text-base font-medium text-gray-900 dark:text-gray-300">
                                {{$item->name}}
                            </label>
                        </div>
                    </div>
                    @endforeach
                    @error('editSuggestionId')
