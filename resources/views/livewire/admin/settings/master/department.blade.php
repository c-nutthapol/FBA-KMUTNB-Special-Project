                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" id="txtdepart" wire:model="name" class="input"
                                placeholder="กรุณากรอกสาขา" required></input>
                            @error('name')
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" id="edittxtdapart" wire:model="t_name" class="input"
                                placeholder="กรุณากรอกสาขา" required></input>
                            @error('t_name')
                                <span
