                ...
                <div
                    ...
                    {{-- <button type="button" id="btninsert"
                        ...
                        <div class="flex flex-row items-center justify-center gap-3">
                            ...
                            <span class="block">เพิ่มข้อมูลการติดต่อ</span>
                        </div>
                    </button> --}}
                </div>
            ...
            <form class="relative rounded-lg bg-white shadow dark:bg-gray-700" wire:submit.prevent="submit">
                ...
                <div class="flex items-start justify-between rounded-t border-b p-4 dark:border-gray-600">
                    <h3 class="mb-0 text-xl font-semibold tracking-wide text-gray-900 dark:text-slate-300">
                        <i class="bi bi-plus-lg leading-0"></i> เพิ่มข้อมูลการติดต่อ
                    </h3>
                    <button type="button"
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <textarea class="input" wire:model="name" placeholder="กรุณากรอกข้อมูลการติดต่อ" rows="2"></textarea>
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            {{-- <span class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">กรุณากรอกข้อมูลการติดต่อ</span> --}}
                        </div>
    ...
    <div id="editModal" data-modal-backdrop="static" wire:ignore.self tabindex="-1" aria-hidden="true"
        ...
        <div class="relative h-full w-full max-w-2xl md:h-auto">
            ...
            <form class="relative rounded-lg bg-white shadow dark:bg-gray-700" wire:submit.prevent="update">
                ...
                <div class="flex items-start justify-between rounded-t border-b p-4 dark:border-gray-600">
                    <h3 class="mb-0 text-xl font-semibold tracking-wide text-gray-900 dark:text-slate-300">
                        <i class="bi bi-pencil-square leading-0"></i> แก้ไขข้อมูลการติดต่อ
                    </h3>
                    <button type="button"
                        class="ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <textarea class="input" wire:model="t_name" placeholder="กรุณากรอกข้อมูลการติดต่อ" rows="2"></textarea>
                            @error('t_name')
                                <span
