                ...
                <div
                    ...
                    <button type="button" class="w-full text-sm text-white sm:w-auto btn from-blue-500 to-violet-500"
                        ...
                        <div class="flex flex-row items-center justify-center gap-3">
                            ...
                            <span class="block">เพิ่มประเภทข่าว</span>
                        </div>
                    </button>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" wire:model="name" class="input" placeholder="กรุณากรอกประเภทข่าว" required></input>
                            @error('name')
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" wire:model="t_name" class="input" placeholder="กรุณากรอกประเภทข่าว" required></input>
                            @error('t_name')
