            ...
            <form class="relative rounded-lg bg-white shadow dark:bg-gray-700" wire:submit.prevent="submit">
                ...
                <div class="flex items-start justify-between rounded-t border-b p-4 dark:border-gray-600">
                    <h3 class="mb-0 text-xl font-semibold tracking-wide text-gray-900 dark:text-white">
                        <i class="bi bi-plus-lg leading-0"></i> เพิ่มคำร้อง
                    </h3>
                    <button type="button"
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" wire:model="name" class="input" placeholder="กรุณากรอกคำร้อง"
                                required></input>
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            {{-- <span class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">กรุณากรอกคำร้อง</span> --}}
                        </div>
                    </div>
                </div>
                <!-- Modal footer -->
    ...
    <div id="editModal" data-modal-backdrop="static" wire:ignore.self tabindex="-1" aria-hidden="true"
        ...
        <div class="relative h-full w-full max-w-2xl md:h-auto">
            ...
            <form class="relative rounded-lg bg-white shadow dark:bg-gray-700" wire:submit.prevent="update">
                ...
                <div class="flex items-start justify-between rounded-t border-b p-4 dark:border-gray-600">
                    <h3 class="mb-0 text-xl font-semibold tracking-wide text-gray-900 dark:text-white">
                        <i class="bi bi-pencil-square leading-0"></i> แก้ไขคำร้อง
                    </h3>
                    <button type="button"
                        class="ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" id="requesttext" class="input" placeholder="กรุณากรอกคำร้อง"
                                wire:model="t_name" required></input>
                            @error('t_name')
                                <span
