        ...
        <form class="relative bg-white rounded-lg shadow dark:bg-gray-700" wire:submit.prevent="submit">
                            ...
                            @foreach ($edu_terms as $key => $edu_term)
                                <div class="flex items-center">
                                    <input id="term-{{ $key }}" type="radio" value="{{ $edu_term->id }}"
                                        name="edu_term_id" wire:model.defer="edu_term_id" class="w-4 h-4 input-radio">
                                    <label for="term-{{ $key }}"
                    ...
                    <div class="col-span-2 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="phase_1_start_date" wire:model.defer="phase_1_start_date"
                                    class="input" />
                            ...
                            <div>
                                ...
                                <input type="date" id="phase_1_end_date" wire:model.defer="phase_1_end_date"
                                    class="input" />
                    ...
                    <div class="col-span-2 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="phase_2_start_date" class="input"
                                    wire:model.defer="phase_2_start_date" />
                            ...
                            <div>
                                ...
                                <input type="date" id="phase_2_end_date" wire:model.defer="phase_2_end_date"
                                    class="input" />
                    ...
                    <div class="col-span-2 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="phase_3_start_date" class="input"
                                    wire:model.defer="phase_3_start_date" />
                            ...
                            <div>
                                ...
                                <input type="date" id="phase_3_end_date" class="input"
                                    wire:model.defer="phase_3_end_date" />
                    ...
                    <div class="col-span-2 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="phase_4_start_date" class="input"
                                    wire:model.defer="phase_4_start_date" />
                            ...
                            <div>
                                ...
                                <input type="date" id="phase_4_end_date" class="input"
            ...
            <div
                ...
                <button type="submit" id="submit"
                    class="text-sm font-medium text-white btn from-blue-500 to-violet-500" wire:target="submit"
