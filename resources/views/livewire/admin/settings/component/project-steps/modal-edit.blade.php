<div id="editModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        ...
        <form class="relative bg-white rounded-lg shadow dark:bg-gray-700" wire:submit.prevent="submit">
            ...
            <!-- Modal body -->
            <div class="p-6">
                <div id="loading-edit" class="p-6 space-y-6 hidden">
                ...
                <div id="modal-proeject-step-edit" class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2 p-3 bg-gray-100 rounded-lg">
                        <div class="flex items-center mb-2">
                            <input id="steps-2" type="checkbox" wire:model.defer="phase_2_status"
                                class="w-4 h-4 input-checkbox">
                            <label for="steps-2"
                                class="ml-2 text-base tracking-wide dark:text-white dark:opacity-80">ลงทะเบียนเพื่อขอสอบหัวข้อ</label>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" wire:model.defer="phase_2_start_date" class="input" />
                    ...
                    <div class="col-span-2 p-3 bg-gray-100 rounded-lg">
                        <div class="flex items-center mb-2">
                            <input id="steps-5" type="checkbox" wire:model.defer="phase_5_status"
                                class="w-4 h-4 input-checkbox">
                            <label for="steps-5"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" class="input" wire:model.defer="phase_5_start_date" />
                                @error('phase_5_start_date')
                                    <span
                                        class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="date" class="input" wire:model.defer="phase_5_end_date" />
                                @error('phase_5_end_date')
                                    <span
                                        class="block mt-1 ml-2 text-sm tracking-wide text-rose-600">{{ $message }}</span>
                                @enderror
                            </div>
