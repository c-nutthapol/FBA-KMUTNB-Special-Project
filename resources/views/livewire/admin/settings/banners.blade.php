                            ...
                            @forelse ($banners as $key => $banner)
                                <tr>
                                    ...
                                    <td
                                        class="whitespace-nowrap border-b bg-transparent px-6 py-3 align-middle shadow-transparent dark:border-slate-600">
                                        <div class="w-32">
                                            <select class="select" onchange="@this.ChangeStatus({{ $banner->id }})">
                                    ...
                                    <td
                                        ...
                                        <div class="flex flex-row justify-end gap-3">
                                            <button type="button" data-modal-target="editModal"
                                                ...
                                                class="inline-block cursor-pointer rounded-lg text-center align-middle text-sm font-bold uppercase leading-normal text-yellow-300 transition-all ease-in hover:text-yellow-500">
