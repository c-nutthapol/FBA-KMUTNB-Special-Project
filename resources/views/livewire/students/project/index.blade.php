...
<div>
    @livewire('students.project.components.header', ['project' => $data->project, 'term' => $data->term])
        ...
        <div class="w-full max-w-full flex-none px-3">
            ...
            <div
                ...
                <div class="pb-6 sm:p-6">
                    ...
                    @if (in_array($data->project->status, [4, 14, 32, 23]))
                                ...
                                <figcaption class="space-y-1 text-center sm:text-left">
                                    ...
                                    <div
                                        ...
                                        <span class="inline-block">รหัสนักศึกษา</span>:<span class="inline-block">
                                            {{ $data->project->user_project->where('role', 'student1')->first()->user->user_code ?? '' }}
                                        </span>
                                    </div>
                                    <div
                                        class="space-x-2 text-base font-normal tracking-wide text-slate-600 dark:text-gray-100">
                                ...
                                <figure
                                    ...
                                    <figcaption class="space-y-1 text-center sm:text-left">
                                        ...
                                        <div
                                            class="space-x-2 text-base font-normal tracking-wide text-slate-600 dark:text-gray-100">
                                            <span class="inline-block">รหัสนักศึกษา</span>:<span class="inline-block">
                                                {{ $data->project->user_project->where('role', 'student2')->first()->user->user_code ?? '' }}
                                            </span>
                                        </div>
                                        <div
                                            class="space-x-2 text-base font-normal tracking-wide text-slate-600 dark:text-gray-100">
            ...
            <form class="relative rounded-lg bg-white shadow dark:bg-gray-700" wire:submit.prevent="submit">
                ...
                <div class="space-y-4 p-6">
                    <div>
                        ...
                        <input class="input h-full p-0" type="file" accept="application/pdf,application/msword"
