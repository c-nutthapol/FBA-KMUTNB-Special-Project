<div id="modalChangeRequest" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        ...
        <form class="relative bg-white rounded-lg shadow dark:bg-gray-700" wire:submit.prevent="submit">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="modalChangeRequest">
            ...
            <div
                ...
                <button data-modal-hide="modalChangeRequest" type="button"
